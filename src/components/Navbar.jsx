...
const Navbar = () => {
  return (
    <div className="navbar bg-background/80 border-b border-white/10 backdrop-blur-sm sticky top-0 z-50 px-4 max-w-7xl mx-auto">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 w-52 p-2 shadow-lg rounded-box z-50
      ...
      <div className="navbar-end">
        <Link
          href="/signup"
          className="btn btn-sm border-none rounded-sm bg-[#e09f2d] text-black font-semibold 
                     hover:bg-[#d18706] transition-colors tracking-wide"
        >
          Login
        </Link>
      </div>
